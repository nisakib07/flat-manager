...
// Main tabs - most frequently used actions (now 4 items)
const mainTabs = [
  ...
  { name: 'Deposits', href: '/deposits', icon: 'M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z' },
] as const

// Menu items - less frequently accessed sections
const menuItems = [
  { name: 'Utilities', href: '/utilities', icon: 'M13 10V3L4 14h7v7l9-11h-7z', color: 'hsl(38 92% 50%)' },
  { name: 'Common Expenses', href: '/common-expenses', icon: 'M17 9V7a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2m2 4h10a2 2 0 002-2v-6a2 2 0 00-2-2H9a2 2 0 00-2 2v6a2 2 0 002 2zm7-5a2 2 0 11-4 0 2 2 0 014 0z', color: 'hsl(160 84% 39%)' },
